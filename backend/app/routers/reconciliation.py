...
def list_relationships(
    ...
    query = """
        SELECT r.*,
               f1.id as f1_id, f1.document_id as f1_doc_id, f1.page_number as f1_page, f1.entity as f1_entity, f1.category as f1_cat,
               ...
               f2.id as f2_id, f2.document_id as f2_doc_id, f2.page_number as f2_page, f2.entity as f2_entity, f2.category as f2_cat,
    ...
    for r in rows:
        fact_1 = FactResponse(
            ...
            entity=r["f1_entity"] if "f1_entity" in r.keys() and r["f1_entity"] else "",
            category=r["f1_cat"],
            subject=r["f1_sub"],
            predicate=r["f1_pred"],
            value=r["f1_val"],
        ...
        fact_2 = FactResponse(
            ...
            entity=r["f2_entity"] if "f2_entity" in r.keys() and r["f2_entity"] else "",
            category=r["f2_cat"],
            subject=r["f2_sub"],
            predicate=r["f2_pred"],
            value=r["f2_val"],
