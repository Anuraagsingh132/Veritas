...
def _row_to_fact_response(row_prefix: str, row) -> FactResponse:
    ...
    return FactResponse(
        ...
        entity=row[f"{row_prefix}_entity"] if f"{row_prefix}_entity" in row.keys() and row[f"{row_prefix}_entity"] else "",
...
def get_four_required_cases():
    ...
    query_template = """
        SELECT r.id as rel_id, r.relationship_type, r.confidence as rel_conf, r.reasoning as rel_reasoning,
               ...
               f1.page_number as f1_page, f1.entity as f1_entity, f1.category as f1_category, f1.subject as f1_subject,
               ...
               f2.page_number as f2_page, f2.entity as f2_entity, f2.category as f2_category, f2.subject as f2_subject,
    ...
    if row4:
        ...
        fail_fact = FactResponse(
            ...
            entity=row4["entity"] if "entity" in row4.keys() and row4["entity"] else "",
