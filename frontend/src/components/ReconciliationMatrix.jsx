...
export default function ReconciliationMatrix({ relationships, loading, onTriggerReconciliation }) {
  ...
  const paginatedRelationships = filtered.slice(
    ...
    switch (type) {
      ...
      case 'genuine_contradiction':
        return {
          ...
          relationSymbol: '≠',
          relationText: 'Direct Contradiction',
      ...
      default:
        return {
          ...
          relationSymbol: '⟷',
          relationText: 'Context Difference',
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800/80 pb-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className={`inline-flex items-center space-x-1 px-2.5 py-0.5 rounded-md font-mono text-[11px] font-semibold border ${badge.relationClass}`}>
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between pt-2 text-xs text-slate-400">
              <span className="tabular-nums">
                ...
                <strong className="text-slate-200">{Math.min(currentPage * ITEMS_PER_PAGE, filtered.length)}</strong> of{' '}
